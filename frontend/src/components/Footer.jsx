const Footer = () => {
  return (
    <div className="mt-[40px] bg-gray-300 px-[200px] h-[60vh]">
      {/* upper part */}
      <div className="flex justify-between">
        <div className="flex flex-col items-center">
          <img src="/logo-transparent.png" alt="logo" className="h-[150px]" />
          <h2 className="font-semibold">
            Lets dive into the Store to help you get the best for your skin type
          </h2>
        </div>
        <div className="mt-10"> 
          ...
          <div className="mt-3">
            <ul>
            <li className="hover:underline cursor-pointer"><a src="/">Home</a></li>
            <li className="hover:underline cursor-pointer"><a src="/cart">Cart</a></li>
            <li className="hover:underline cursor-pointer"><a src="/Myaccount">Myaccount</a></li>
          </ul>
          </div>
        </div>
        <div className="mt-10">
          <h2 className="text-xl">Contact</h2>
            <div className="mt-3">
            <ul>
            <li>Phone.no: 9873704276</li>
            <li>email: shivampathak7789@gmail.com</li>
          </ul>
            </div>
        </div>
      </div>

          <div className="mt-16 border-t border-[#8FB59E] pt-4 text-center">
        <p>&copy; 2025 Blushify. All rights reserved.</p>
