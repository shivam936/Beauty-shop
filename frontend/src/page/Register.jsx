            ...
            <h2 className="font-semibold text-xl mb-6">Create Account</h2>
                <form >
                     <div className="mb-4">
                        ...
                        <input type="text" className="p-2 w-full border border-gray-400 outline-none focus:outline-none rounded-md focus:ring-2 focus:ring-[#8FB59E]" placeholder='John doe' />
                    </div>
